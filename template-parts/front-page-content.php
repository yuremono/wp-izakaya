								...
								<section>
										<div class="mv bg100 c143">
												...
												<div class="clearfix mv_h js-hide c464">
														<img src="<?php echo esc_url( theme_source_uri( 'images/home/mv_logo.png' ) ); ?>" alt=""
																class="imgL">
												</div><!-- #c464 -->
										...
										<div class="second c462">
												...
												<div class="clearfix has-h1 f18 c507">
														...
														<div><span
																...
																お店の名前は、焼酎の本場、鹿児島とお店のある上尾から一文字づつとり鹿尾と名付けました。<br />
																是非、焼酎BAR鹿尾でお好みの焼酎と出会い、素敵な時間をお過ごしください。
														</div>
												</div><!-- #c507 -->
